...
from projects.MGN.build_losses import reid_losses
...
class MGN(nn.Module):
    ...
    def losses(self, outputs):
        loss_dict = {}
        loss_dict.update(reid_losses(self._cfg, outputs[0][0], outputs[1][0], outputs[2], 'b1_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][1], outputs[1][1], outputs[2], 'b2_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][2], outputs[1][2], outputs[2], 'b3_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][3], None, outputs[2], 'b21_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][4], None, outputs[2], 'b22_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][5], None, outputs[2], 'b31_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][6], None, outputs[2], 'b32_'))
        loss_dict.update(reid_losses(self._cfg, outputs[0][7], None, outputs[2], 'b33_'))
        return loss_dict
